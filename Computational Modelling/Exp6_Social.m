...
for i = 1:5
    ...
    for IPD = 2:4
        ...
        EnergyMap1 = GetMap(width/precision+1,Target(2)/precision+1,BlockerL/precision,BlockerL_Ori,m,n,a,b,c,precision);
        EnergyMap2 = GetMap(width/precision+1,Target(2)/precision+1,BlockerR/precision,BlockerR_Ori,m,n,a,b,c,precision);
...
dlmwrite('./results/path_interaction(social).csv',pathall);
...
pathall(:,4) = pathall(:,4) - 500;
dlmwrite('./results/path_interaction_social.csv',pathall);