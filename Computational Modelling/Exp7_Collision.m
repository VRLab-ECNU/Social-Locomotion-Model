...
%             disp(['Subject Position: ' num2str(subPath(d1==min(d1),2))]);
            ...
            EnergyMap = GetPhysicalMap(width/precision+1,Target(2)/precision+1,Blocker,Blocker_Ori,m,n,a,b,c,precision);
        ...
        pathlengthL = [pathlengthL;arclength(subPath1(:,1),subPath1(:,2))];
...
%             disp(['Subject Position: ' num2str(subPath(d1==min(d1),2))]);
        ...
        pathlengthR = [pathlengthR;arclength(subPath1(:,1),subPath1(:,2))];
...
pathlengthRatio = pathlengthL./pathlengthR;
...
dlmwrite('./results/path_dynamic(collision).csv',newsubpathall);
save('./results/dynamicpath(collision).mat','newsubpathall')
...
dlmwrite('./results/corD_c.csv',modelPrediction);