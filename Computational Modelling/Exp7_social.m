...
realdata = dlmread('/Users/chen_zhou/R_WorkingDirectory/Walking/finaldata.csv');
realP = realdata(:,3);
...
% a = 5.647; b = -6.143;
% modelP1 = 1./(1+exp(a+b*socialEnergyRatio));
% modelPrediction = [realP,modelP1];
modelPrediction = [realP,socialEnergyRatio];
dlmwrite('./results/corI.csv',modelPrediction);

% a = 19.96; b = -18.84;
% modelP = 1./(1+exp(a+b*pathlengthRatio));
modelPrediction = [realP,pathlengthRatio];
dlmwrite('./results/corIP.csv',modelPrediction);